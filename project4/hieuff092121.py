# Nice work there, but what is the usage of time.sleep(10)? You should save the dataframe to a csv file.
# Also you are hardcoding the position of 3 currencies. What if they are not in that position anymore?
