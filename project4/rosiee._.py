...
def get_crypto_data(crypto_name):
    ...
    if row:
        ...
        if parent:
            ...
            price = parent.find('div', class_='sc-b3fc6b7-0 dzgUIj').find('span').text.strip()
            ...
            volume_24h = parent.find('div', class_='sc-4c05d6ef-0 sc-97d9abce-0 dlQYLv bJRjhz').find('p').text.strip()
