# Nice work! But seems like u hardcode too much, and the code is not really clean. Furthermore, what if BNB rank changes to 5th or not in the first page? You should consider that case.
# And it would be better if you can save the dataframe to a csv file.
