# Nice work! But do not provide us your api key :D.
...
def get_crypto_data(crypto_ids):
    ...
    params = {"id": ",".join(crypto_ids)}
    headers = {
        'X-CMC_PRO_API_KEY': 'YOU_MUST_NEVER_PUBLIC_YOUR_API_KEY' #thay api key của bạn vào đây
    }
