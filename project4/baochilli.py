# Nice work! But save the dataframe to a csv file would be better than just printing it out.
# Also your code are printing out Name + Symbol, you should parse the name of crypto more carefully.
