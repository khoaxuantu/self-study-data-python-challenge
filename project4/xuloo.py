...
def fetch_and_write_data():
    ...
    table = soup.select_one("div.sc-2e66506f-1.buMEwe.global-layout-v2 > div.main-content > div.cmc-body-wrapper > div > div:nth-child(1) > div.sc-7b3ac367-2.cFnHu > table")
...
if __name__ == "__main__":
    ...
    with open('coinmarketcap.csv', 'w', encoding='utf-8', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(['Rank', 'Name', 'Price', '1h %', '24h %', '7d %', 'Market Cap', 'Volume (24h)', 'Circulating Supply', 'Timestamp'])
