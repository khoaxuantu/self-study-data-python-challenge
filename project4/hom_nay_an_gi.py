# Nice work! But instead of printing the df out, you should save it to a csv file. And you should parse the name of currencies more carefully, because your code is currently showing the symbol as well.
