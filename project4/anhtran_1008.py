...
# Nice work after all, but you should parse the name of crypto more carefully, because your code is currently printing out Name + Symbol.
# Also, save the dataframe to a csv file would be better than just printing it out.
