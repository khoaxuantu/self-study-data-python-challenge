# Nice work! It would be better if you can save the dataframe to a csv file. Also you should parse the name more carefully, as currently it includes the ticker symbol.
