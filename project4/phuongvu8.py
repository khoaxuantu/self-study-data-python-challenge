# Great work! But you are hardcoding the numbers of rows to scrape. What if BNB is not in the first 4 rows? You should consider this case.
# And you should also parse the name of currencies, because it currently includes the symbol of the currency.
