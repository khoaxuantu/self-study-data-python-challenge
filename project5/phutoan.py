...
for job in job_cards:
    ...
    if re.search(programming_languages, job_description, re.IGNORECASE) and \
            re.search(keywords_include, job_description, re.IGNORECASE) and \
            not re.search(keywords_exclude, job_description, re.IGNORECASE):
