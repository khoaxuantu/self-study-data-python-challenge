# Great work! I did comment on your code (find NOTE:). Please check it out and make sure to implement the bonus point features.
...
def Scrape_job_listings():
    ...
    # NOTE: should also handle the case where the page does not exist
            ...
            if job_item:
                ...
                welfare = ", ".join(
                    [
                        ...
                        for item in welfare_tags[0].find_all("li")
                    ]
                    if welfare_tags
                    else []
                )
                expire_date = job_item.find("div", class_="expire-date").get_text(
                    strip=True
                )
...
if __name__ == "__main__":
    ...
    print(
        "1. Retrieve job listings data from the website Carrerviet.vn and save it to a CSV file."
    )
